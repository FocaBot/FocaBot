...
declare module 'azarasi/lib/locales' {
  interface Locale {
    ...
    "moderation" : {
      ...
      "kicked" : string
      /**
       * Couldn't kick user. Please check the bot permissions.
       */
      "cantKick" : string
      /**
      ...
      "banned" : string
      /**
       * Couldn't ban user. Please check the bot permissions.
       */
      "cantBan" : string
      /**
       * (No reason specified)
      ...
      "raidDetected" : string
      /**
       * Triggering anti-raid features. (Run {1}resetAntiRaid to reset everything back to normal)
       */
      "antiRaidAlert" : string
      /**
       * Anti-raid not currently triggered. Nothing to do.
       */
      "antiRaidNotActive" : string
      /**
       * (Anti Raid) Resetting everything back to normal...
       */
      "raidResetting" : string
      /**
       * Kick all users associated with this raid? (Users with roles other than the raid role will be spared)
       */
      "raidKickPrompt" : string
      /**
       * Kicking all users associated with a recent raid...
       */
      "raidKick" : string
      /**
       * Automatic Role
